...
import pandas as pd
from sqlalchemy import create_engine, Column, Integer, String, Float, Date, Boolean, UniqueConstraint, ForeignKey
...
def admin_payroll(
    ...
    try:
        ...
        for shift in shifts:
            ...
            key = (shift.employee, shift.store)
        ...
        rows.sort(key=lambda x: (x["employee_name"], x["store"]))
